...
public class RenderGlobal implements IWorldAccess
{
    ...
    /**Vex lines to players, items or chests**/
    public void tracerLine()
    {
        try
        {
            ...
            if (Variables.chestLine)
            {
                ...
                {
                    TileEntity tileentity = (TileEntity)mc.theWorld.loadedTileEntityList.get(i);
                    double d2 = (double)tileentity.xCoord + 0.5D;
                    double d4 = tileentity.yCoord - 1;
                    double d6 = (double)tileentity.zCoord + 0.5D;
                    double d8 = mc.thePlayer.posX;
                    double d10 = mc.thePlayer.posY;
                    double d12 = mc.thePlayer.posZ;
                    double d14 = d8 - d2;
                    double d16 = d10 - d4;
                    double d18 = d12 - d6;
                    ...
                    if (!((TileEntityChest)tileentity).checkForCloseMoss())
                    {
                        if (tileentity.getDistanceFrom(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ) <= 5000D)
                        {
                            GL11.glColor3f(191F, 191F, 0.0F);
                            GL11.glVertex3d((-d14 + d) - 0.5D, (d1 - d16) + 1.3D, (-d18 - d) + 0.5D);
                        }
                        else
                        {
                            GL11.glColor3f(0.0F, 191F, 191F);
                            GL11.glVertex3d((-d14 + d) - 0.5D, (d1 - d16) + 1.3D, (-d18 - d) + 0.5D);
                        }
            ...
            for (int j = 0; j < mc.theWorld.loadedEntityList.size(); j++)
            {
                ...
                double d9 = mc.thePlayer.posX;
                double d11 = mc.thePlayer.posY;
                double d13 = mc.thePlayer.posZ;
                double d15 = d9 - d3;
                double d17 = d11 - d5;
                double d19 = d13 - d7;
                ...
                if (Variables.drops)
                {
                    ...
                    if (entity instanceof EntityItem)
                    {
                        ...
                        if (entityitem.getEntityItem().itemID == 57 || entityitem.getEntityItem().itemID == 264 || entityitem.getEntityItem().itemID == 276 || entityitem.getEntityItem().itemID == 277 || entityitem.getEntityItem().itemID == 278 || entityitem.getEntityItem().itemID == 279 || entityitem.getEntityItem().itemID == 293 || entityitem.getEntityItem().itemID == 310 || entityitem.getEntityItem().itemID == 311 || entityitem.getEntityItem().itemID == 312 || entityitem.getEntityItem().itemID == 313)
                        {
                            GL11.glColor3f(0.0F, 191F, 191F);
                        }
                        else if (entityitem.getEntityItem().itemID == 41 || entityitem.getEntityItem().itemID == 266 || entityitem.getEntityItem().itemID == 283 || entityitem.getEntityItem().itemID == 284 || entityitem.getEntityItem().itemID == 285 || entityitem.getEntityItem().itemID == 286 || entityitem.getEntityItem().itemID == 294 || entityitem.getEntityItem().itemID == 314 || entityitem.getEntityItem().itemID == 315 || entityitem.getEntityItem().itemID == 316 || entityitem.getEntityItem().itemID == 317 || entityitem.getEntityItem().itemID == 322 || entityitem.getEntityItem().itemID == 321)
                        {
                            GL11.glColor3f(191F, 191F, 0.0F);
                        }
                        else if (entityitem.getEntityItem().itemID == 42 || entityitem.getEntityItem().itemID == 265 || entityitem.getEntityItem().itemID == 267 || entityitem.getEntityItem().itemID == 256 || entityitem.getEntityItem().itemID == 257 || entityitem.getEntityItem().itemID == 258 || entityitem.getEntityItem().itemID == 292 || entityitem.getEntityItem().itemID == 306 || entityitem.getEntityItem().itemID == 307 || entityitem.getEntityItem().itemID == 308 || entityitem.getEntityItem().itemID == 309)
                        {
                            GL11.glColor3f(191F, 191F, 191F);
                        }
                        else
                        {
                        ...
                        GL11.glVertex3d((-d15 + d) - 0.5D, d1 - d17, (-d19 - d) + 0.5D);
                    }

                    GL11.glEnd();
                }

                if (d3 == d9 || d5 == d11 || d7 == d13 || entity == mc.thePlayer || !(entity instanceof EntityPlayer))
                {
                    continue;
                }
                ...
                if (GuiIngame.FriendList.contains(entityplayer.username.toLowerCase()))
                {
                    GL11.glColor3f(0.0F, 191F, 0.0F);
                    GL11.glVertex3d((-d15 + d) - 0.5D, (d1 - d17) + 1.3D, (-d19 - d) + 0.5D);
                }
                else if (GuiIngame.EnemyList.contains(entityplayer.username.toLowerCase()))
                {
                    GL11.glColor3f(191F, 0.0F, 0.0F);
                    GL11.glVertex3d((-d15 + d) - 0.5D, (d1 - d17) + 1.3D, (-d19 - d) + 0.5D);
                }
                else if (entityplayer.getDistanceToEntity(mc.thePlayer) <= 25F)
                {
                    GL11.glColor3f(191F, 0.0F, 191F);
                    GL11.glVertex3d((-d15 + d) - 0.5D, (d1 - d17) + 1.3D, (-d19 - d) + 0.5D);
                }
                else
                {
                    GL11.glColor3f(64F, 64F, 64F);
                    GL11.glVertex3d((-d15 + d) - 0.5D, (d1 - d17) + 1.3D, (-d19 - d) + 0.5D);
                }
    ...
    public static void chestRadar(double d, double d1, double d2, float f, boolean flag)
    {
        ...
        if (flag)
        {
            GL11.glColor4d(0.0D, 0.0D, 0.0D, 0.15D);
        }
        else
        {
            GL11.glColor4d(0.0D, 255D, 100D, 0.15D);
        }
        ...
        {
            GL11.glColor4d(0.0D, 255D, 100D, 1.0D);
        }

        drawOutlinedBoundingBox(new AxisAlignedBB(d, d1, d2, d + 1.0D, d1 + 1.0D, d2 + 1.0D));
        GL11.glLineWidth(2.0F);
        chestLines(new AxisAlignedBB(d, d1, d2, d + 1.0D, d1 + 1.0D, d2 + 1.0D));
        GL11.glEnable(GL11.GL_TEXTURE_2D);
    ...
    /** vex draws a line to the chest**/
    public static void chestLines(AxisAlignedBB axisalignedbb)
    {
        GL11.glLineWidth(2.0F);
        GL11.glBegin(GL11.GL_LINES);
    ...
    /** Vex draws a box around the player**/
    public static void playerBox(Entity entity, double d, double d1, double d2)
    {
        try
        {
            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
            ...
            if ((entity instanceof EntityPlayer) && entity != Minecraft.theMinecraft.thePlayer)
            {
                EntityPlayer entityplayer = (EntityPlayer)entity;
                ...
                {
                    GL11.glColor3f(0.0F, 191F, 0.0F);
                    drawOutlinedBoundingBox(new AxisAlignedBB(d - 0.5D, d1 + 0.1D, d2 - 0.5D, d + 0.5D, d1 + 2D, d2 + 0.5D));
                }
                else if (GuiIngame.EnemyList.contains(entityplayer.username.toLowerCase()))
                {
                    GL11.glColor3f(191F, 0.0F, 0.0F);
                ...
                else if (entityplayer.getDistanceToEntity(Minecraft.theMinecraft.thePlayer) <= 25F)
                {
                    GL11.glColor3f(191F, 0.0F, 191F);
                    drawOutlinedBoundingBox(new AxisAlignedBB(d - 0.5D, d1 + 0.1D, d2 - 0.5D, d + 0.5D, d1 + 2D, d2 + 0.5D));
                }
    ...
    /** VEX DRAWS A FULL BOX AROUND THE BLOCK**/
