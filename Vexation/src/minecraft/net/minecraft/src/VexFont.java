...
public class VexFont
{
    ...
    public VexFont(Minecraft minecraft, Object obj, int i)
    {
        this(minecraft, obj, i, 32, 126);
    }

    public VexFont(Minecraft minecraft, Object obj, int i, int j, int k)
    {
        startChar = j;
        endChar = k;
        xPos = new int[k - j];
    ...
    private void drawChar(Gui gui, char c, int i, int j)
    {
        ...
        gui.drawTexturedModalRect(i, j, xPos[(byte)c - startChar], yPos[(byte)c - startChar], (int)rectangle2d.getWidth(), (int)rectangle2d.getHeight() + metrics.getMaxDescent());
    }
}
