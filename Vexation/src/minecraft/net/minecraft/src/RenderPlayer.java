...
public class RenderPlayer extends RenderLiving
{
    ...
    {
    	if (Variables.line || Variables.playerBox)
        {
            RenderGlobal.playerBox(par1EntityPlayer, par2, par4, par6);
        }
        float var10 = 1.0F;
    ...
    protected void renderName(EntityPlayer par1EntityPlayer, double par2, double par4, double par6)
    {
        ...
        {
        	//VEX
            float var8 = Variables.name? 7.0F : 1.6F;
            ...
            if (var10 < (double)(var12 * var12))
            {
                ...
                if (par1EntityPlayer.isSneaking())
                {
                	...
                	if(Variables.name)
                	{
                        ...
                        GL11.glPushMatrix();
                        GL11.glTranslatef((float)par2 + 0.0F, (float)par4 + 3F, (float)par6);
						...
						int i = fontrenderer.getStringWidth(var13) / 2;
						tessellator.setColorRGBA_F(0.0F, 0.0F, 0.0F, 0.5F);
						tessellator.addVertex(-i - 1, -1.2D, 0.0D);
						tessellator.addVertex(-i - 1, 7.8D, 0.0D);
						tessellator.addVertex(i + 1, 7.8D, 0.0D);
						tessellator.addVertex(i + 1, -1.2D, 0.0D);
						tessellator.draw();
						GL11.glEnable(GL11.GL_TEXTURE_2D);
						fontrenderer.drawString(var13,
								-fontrenderer.getStringWidth(var13) / 2, 0,
								0xcd0000);
						...
						FontRenderer var14 = this
								.getFontRendererFromRenderManager();
						GL11.glPushMatrix();
						GL11.glTranslatef((float) par2 + 0.0F,
								(float) par4 + 2.3F, (float) par6);
						GL11.glNormal3f(0.0F, 1.0F, 0.0F);
						...
						GL11.glEnable(GL11.GL_TEXTURE_2D);
						GL11.glDepthMask(true);
						var14.drawString(var13,
								-var14.getStringWidth(var13) / 2, 0, 553648127);
						GL11.glEnable(GL11.GL_LIGHTING);
						GL11.glDisable(GL11.GL_BLEND);
						GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
						GL11.glPopMatrix();
