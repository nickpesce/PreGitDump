...
public abstract class Scene {
	...
	/**
	 * Convenience method. Adds a clickbox to the scene.
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	...
	/**
	 * Called whenever the scene is displayed.
	 */
	public void onEnter()
	{
	...
	/**
	 * Called whenever the scene stops being displayed.
	 */
	public void onLeave()
	{
	...
	/**
	 * Called when the mouse is hovering over a clickbox and moves position.
	...
	/**
	 * called every time the mouse is moved. Same as mouseMotionListener.mouseMoved
	 * @param x
	 * @param y
	 */
	...
	/**
	 * Sets the background to a bufferedimage.
	 * @param background Image to set background to.
	 */
	...
	/**
	 * Convenience method. Sets the background image using the path to the file.
