...
public class GuiVexTextFieldPrivate extends Gui
{
    /**
    ...
    public GuiVexTextFieldPrivate(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5)
    {
    ...
    protected String protectPassword(int i)
    {
        char ac[] = new char[i];
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (var4.length() > 0)
            {
                ...
                var9 = this.fontRenderer.drawStringWithShadow(protectPassword(var10.length()), var7, var8, var1);
            }
            ...
            {
                this.fontRenderer.drawStringWithShadow(protectPassword(var4.substring(var2).length()), var9, var8, var1);
            }
