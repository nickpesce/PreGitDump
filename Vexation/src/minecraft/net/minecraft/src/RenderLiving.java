...
public class RenderLiving extends Render
{
    ...
    protected void renderLivingLabel(EntityLiving par1EntityLiving, String par2Str, double par3, double par5, double par7, int par9)
    {
        ...
        if (Variables.name)
        {
            if (GuiIngame.FriendList.contains(par2Str))
            {
                FontRenderer fontrenderer = getFontRendererFromRenderManager();
                float f1 = 7F;
                float f3 = 0.01666667F * f1;
                GL11.glPushMatrix();
                GL11.glTranslatef((float)par3 + 0.0F, (float)par5 + 3F, (float)par7);
                ...
                int k = fontrenderer.getStringWidth(par2Str) / 2;
                tessellator.setColorRGBA_F(191F, 0.0F, 191F, 0.25F);
                tessellator.addVertex(-k - 1, -1.2D, 0.0D);
                tessellator.addVertex(-k - 1, 7.8D, 0.0D);
                tessellator.addVertex(k + 1, 7.8D, 0.0D);
                tessellator.addVertex(k + 1, -1.2D, 0.0D);
                tessellator.draw();
                GL11.glEnable(GL11.GL_TEXTURE_2D);
                fontrenderer.drawString(par2Str, -fontrenderer.getStringWidth(par2Str) / 2, i, 48896);
            ...
            {
                FontRenderer fontrenderer1 = getFontRendererFromRenderManager();
                float f2 = 7F;
                float f4 = 0.01666667F * f2;
                GL11.glPushMatrix();
                GL11.glTranslatef((float)par3 + 0.0F, (float)par5 + 3F, (float)par7);
                GL11.glNormal3f(0.0F, 1.0F, 0.0F);
                GL11.glRotatef(-renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
                ...
                int l = fontrenderer1.getStringWidth(par2Str) / 2;
                tessellator1.setColorRGBA_F(0.0F, 191F, 0.0F, 0.25F);
                tessellator1.addVertex(-l - 1, -1.2D, 0.0D);
                tessellator1.addVertex(-l - 1, 7.8D, 0.0D);
                tessellator1.addVertex(l + 1, 7.8D, 0.0D);
                tessellator1.addVertex(l + 1, -1.2D, 0.0D);
                tessellator1.draw();
                GL11.glEnable(GL11.GL_TEXTURE_2D);
                fontrenderer1.drawString(par2Str, -fontrenderer1.getStringWidth(par2Str) / 2, j, 0xbf00bf);
                GL11.glEnable(GL11.GL_DEPTH_TEST);
                GL11.glDepthMask(true);
                fontrenderer1.drawString(par2Str, -fontrenderer1.getStringWidth(par2Str) / 2, j, 0xbf00bf);
                GL11.glEnable(GL11.GL_LIGHTING);
