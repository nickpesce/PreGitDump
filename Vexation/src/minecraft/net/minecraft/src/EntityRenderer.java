            ...
            else
            {
                ...
                else
                {
                    ...
                    if (this.mc.theWorld.provider.getWorldHasVoidParticles() && !var4)
                    {
                        ...
                        if (Variables.fog || Variables.Xray || Variables.find || Variables.CaveFinder)
                            var13 = 127D;
                        else
                        	var13  = (double)((var3.getBrightnessForRender(par2) & 15728640) >> 20) / 16.0D + (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)par2 + 4.0D) / 32.0D;
