...
public class GuiVexButton extends Gui
{
    protected int width;
    ...
    public GuiVexButton(int i, int j, int k, String s)
    {
        this(i, j, k, 200, 20, s);
    }

    public GuiVexButton(int i, int j, int k, int l, int i1, String s)
    {
        width = 200;
        height = 20;
        enabled = true;
    ...
    public void drawButton(Minecraft minecraft, int i, int j)
    {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, minecraft.renderEngine.getTexture("/gui/VexButton.png"));
