...
public class GuiChat extends GuiScreen
{
    ...
    /**console command that is most likely correct **/
    ...
    protected void keyTyped(char par1, int par2)
    {
        ...
        {
        	//VEX
        	if(Variables.Console && this.inputField.getText().startsWith("-"))
        		this.inputField.setText(selectedCommand);
        	else
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (Variables.Console)
        {
            ...
            for (int j = 0; j < Variables.consoleText.length; j++)
            {
                if (s.contains(" "))
                {
                    String as[] = s.split(" ");
                ...
                if (!Variables.consoleText[j].startsWith(s))
                {
                    continue;
                }

                String s1 = Variables.consoleText[j];

                if (s.length() > 0)
                {
                    drawRect(2, i - 2, width - 2, i + 12, 0xff00bf00);
                    drawRect(3, i - 1, width - 3, i + 11, 0xffbf00bf);
                    drawString(mc.fontRenderer, s1, 6, i, 0xff00bf00);
                }
                ...
                if (i == height - 28)
                {
                    ...
                    if (Variables.consoleText[j].contains(" ["))
                    {
                        as1 = Variables.consoleText[j].split("\\[");
                    }
                    else
                    {
                        as1 = Variables.consoleText[j].split(":");
                    ...
                    selectedCommand = (new StringBuilder()).append("-").append(as1[0]).toString();
                }
