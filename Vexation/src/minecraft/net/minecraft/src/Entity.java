...
public abstract class Entity
{
    ...
    /**
     * VEX- made static How high this entity can step up when running into a block to try to get over it (currently make note the entity
    ...
    {
    	//VEX-----------
    	if (Variables.fullbright || Variables.Xray || Variables.find || Variables.CaveFinder || Variables.mobFind)
        {
            return 1000;
        }
    ...
    /**
     * VEX fullbright Gets how bright this entity is.
     */
