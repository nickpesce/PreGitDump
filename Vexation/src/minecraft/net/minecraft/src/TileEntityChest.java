...
public class TileEntityChest extends TileEntity implements IInventory
{
    ...
    //Vex variables
    private Object adjacentMossZNeg;
    private Object adjacentMossXPos;
    private Object adjacentMossXNeg;
    private Object adjacentMossZPos;
    /**
    ...
    /**VEX- Check if the chest is in a dungeon **/
    public boolean checkForCloseMoss()
    {
        adjacentMossZNeg = null;
        adjacentMossXPos = null;
        adjacentMossXNeg = null;
        adjacentMossZPos = null;

        if (!isInvalid() && worldObj != null && Minecraft.theMinecraft.theWorld.blockExists(xCoord, yCoord, zCoord))
        {
            try
            {
                if (worldObj.getBlockId(xCoord - 1, yCoord, zCoord) == Block.cobblestoneMossy.blockID)
                {
                    return true;
                }
                ...
                if (worldObj.getBlockId(xCoord, yCoord, zCoord - 1) == Block.cobblestoneMossy.blockID)
                {
                    return true;
                }
                ...
                if (worldObj.getBlockId(xCoord + 1, yCoord, zCoord + 1) == Block.cobblestoneMossy.blockID)
                {
                    return true;
                }
                ...
                if (worldObj.getBlockId(xCoord, yCoord - 1 - 1, zCoord) == Block.cobblestoneMossy.blockID)
                {
                    return true;
                }

                if (worldObj.getBlockId(xCoord - 1, yCoord - 1, zCoord) == Block.cobblestoneMossy.blockID)
                {
                    return true;
                }
                ...
                if (worldObj.getBlockId(xCoord, yCoord - 1, zCoord - 1) == Block.cobblestoneMossy.blockID)
                {
                    return true;
                }
                ...
                if (worldObj.getBlockId(xCoord + 1, yCoord - 1, zCoord + 1) == Block.cobblestoneMossy.blockID)
                {
                    return true;
                }
                ...
                return worldObj.getBlockId(xCoord - 1, yCoord - 1, zCoord + 1) == Block.cobblestoneMossy.blockID;
            }
            catch (Exception exception)
            {
                Minecraft.theMinecraft.thePlayer.addChatMessage((new StringBuilder()).append("\2474URGENT ERROR. Please report to Diamondsplox").append(exception).toString());
            }
