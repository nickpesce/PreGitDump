...
public class GuiScreen extends Gui {
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		{
			//VEX
			if (controlList.get(var4) instanceof GuiVexButton)
			{
				GuiVexButton guivexbutton = (GuiVexButton) controlList.get(var4);
				guivexbutton.drawButton(mc, par1, par2);
			} 
			else 
			{
	...
	public void handleMouseInput() {
		...
		} else if (this.mc.gameSettings.touchscreen && this.field_85042_b != -1
	...
	public static boolean isCtrlKeyDown() {
		boolean var0 = Keyboard.isKeyDown(28)
				&& Keyboard.getEventCharacter() == 0;
		return Keyboard.isKeyDown(29) || Keyboard.isKeyDown(157) || isMacOs
